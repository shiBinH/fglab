...
<html>
	...
	<body>
		...
		<script type="text/babel" src="js/games2_helper.js"></script>
		<script type="text/babel" src="js/games2_characters.js"></script>
		<script type="text/babel" src="js/games2.js"></script>
